...
\begin{proof}
    ...
    \begin{align*}
        & \left( \sum_{n=2^{k-1}}^{2^k - 1}{\dfrac{1}{a_{n+1}-a_n}} \right) \cdot \left( \sum_{n=2^{k-1}}^{2^k - 1}{a_{n+1}-a_n} \right) \\
        \geq & \left( \sum_{n=2^{k-1}}^{2^k - 1}{1} \right)^2 = (2^k - 2^{k-1})^2 =  4^{k-1}
    \end{align*}
...
\begin{proof}
    ...
    因此
        $$\lim_{n\to\infty}{\dfrac{S_n}{\sqrt{n}}} = \dfrac{n+1}{n} \dfrac{2^{2n}(n!)^2}{2(2n)!\sqrt{n}} - \dfrac{n+1}{2^n\sqrt{n}}$$
    由\textup{Waills}公式知
        $$\lim_{n\to\infty}{\dfrac{S_n}{\sqrt{n}}} = \dfrac{\sqrt{\pi}}{2}$$
