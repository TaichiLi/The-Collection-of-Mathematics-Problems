...
\begin{proof} 
    ...
    又
    $$\lim_{n\to\infty}{\dfrac{n-N_1}{n}} = 1 > \dfrac{1}{2}$$
    $$\lim_{n\to\infty}{\dfrac{x_1 + x_2 + \cdots + x_n}{n}} = 0 > -1$$
    于是，
...
\begin{proof}
    ...
    $$\lim_{n\to\infty}{a_{(n+1)p + i} - a_{np+i}} = \lambda$$
...
\begin{proof}
    ...
    所以
    $$\lim_{n\to\infty}{a_nS_n} = \lim_{n\to\infty}{a_nS} = 0$$
...
\begin{proof}
    ...
    $$\lim_{n\to\infty}{a_n} \in \left[0,\dfrac{1}{2}\right]$$
