...
\begin{proof}
    ...
    由\textup{Cauthy}定理知，
    $$\varphi'(\theta) = 2 \Re{\left( a\imag \euler^{\imag \theta}f'(a\euler^{\imag \theta}) \left( f^{*}(\overline{a}\euler^{-\imag \theta}) - f^{*}(\overline{a}) + \dfrac{d_r^{*}}{r}\overline{a} \right) \right)}$$
    所以
    $$\varphi'(0) = 2 \Re{\left(a\imag f'(a)\dfrac{d_r^{*}}{r}\overline{a}\right)} = -2\dfrac{d_r^{*}}{r}|a|^2\Im{f'(a)} \neq 0$$
