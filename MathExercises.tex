...
\titleformat{\section}{\centering\Large\bfseries}{\S \arabic{section}}{1em}{\vspace{1em}}
\titleformat{\subsection}{\raggedright\large\bfseries}{\arabic{section}.\arabic{subsection}}{1em}{\vspace{1em}}
...
\pagestyle{main}
% \frontpagestyle
\pdfbookmark[0]{目录}{bmk:目录}
\tableofcontents
% \mainpagestyle

\input{MathAnalysis_first.tex}

\input{MathAnalysis_second.tex}

\input{MathAnalysis_third.tex}

\input{LinearAlgebra.tex}

\input{ProbabilityStatistics.tex}

\input{DiscreteMathematics.tex}

\input{ComplexAnalysis.tex}

\input{SignalSystem.tex}
